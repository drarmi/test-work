<form>
	...
	<div class="mb-3 form-check">
		<input type="checkbox" class="form-check-input" id="type_check1" name="home_type[]">
		<label class="form-check-label" for="type_check1"><?php esc_html_e("Панель", "property-core") ?></label>
	</div>
	<div class="mb-3 form-check">
		<input type="checkbox" class="form-check-input" id="type_check2" name="home_type[]">
		<label class="form-check-label" for="type_check2"><?php esc_html_e("Кирпич", "property-core") ?></label>
	</div>
	<div class="mb-3 form-check">
		<input type="checkbox" class="form-check-input" id="type_check3" name="home_type[]">
